...
class MegaDepthDataset(Dataset):
    def __init__(self,
        ...
        mixedTxtPath="/root/data1/Loftr_base/LoFTR/data/megadepth/index/trainvaltest_list_redu/realReduced1To100.txt"
    ...
    def __getitem__(self, idx):
       ...
       # (idx0, idx1), overlap_score, central_matches = self.pair_infos[idx]  #这里改一下数据组织方式把，不知道原来的megadepth是怎么办到的。
        ...
        if mixed_Train==1 and self.mode=='train': 
            ...
            #相关路径规整成变量，从外部读取
            npz_BasePath_mixed="/root/data1/Loftr_base/LoFTR/data/megadepth/index/scene_info_0.1_0.7_reduced4/" #先在这里搞个小test
