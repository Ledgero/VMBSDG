...
# _CN.TRAINER.CANONICAL_LR = 6e-3 #原装
_CN.TRAINER.CANONICAL_LR = 1e-2
...
_CN.TRAINER.MSLR_MILESTONES = [7, 14, 21, 28, 35,42,49,56,63,70]  # MSLR: MultiStepLR
#_CN.TRAINER.MSLR_MILESTONES = [3, 6, 9, 15,21,30]  # MSLR: MultiStepLR
#_CN.TRAINER.MSLR_MILESTONES = [1, 2, 4, 6, 8]   # MSLR: MultiStepLR
...
_CN.TRAINER.N_SAMPLES_PER_SUBSET = 200 #原来代码的
# _CN.TRAINER.N_SAMPLES_PER_SUBSET = 1000 #我自己改的
