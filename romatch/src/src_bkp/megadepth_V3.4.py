...
class MegaDepthDataset(Dataset):
    def __init__(self,
        ...
        self.scene_info['image_paths'] = self.scene_infoBuf['image_paths'].copy() #留意这里会不会影响性能和结果
        ...
        del self.scene_infoBuf #可能要注销掉
        self.pair_infos = [pair_info for pair_info in self.pair_infos if pair_info[1][0] > min_overlap_score] #这里较原代码有修改
        # print("totally pair_infos len: ",len(self.pair_infos))
    ...
    def __getitem__(self, idx):
       # (idx0, idx1), overlap_score, central_matches = self.pair_infos[idx]  #这里改一下数据组织方式把，不知道原来的megadepth是怎么办到的。
        ...
        # print("needed idx0 ", idx0)
        # print("needed idx1 ", idx1)
        # print("error HERE: ",self.scene_info['image_paths'][idx0])
        img_name0 = osp.join(self.root_dir, self.scene_info['image_paths'][idx0])
        img_name1 = osp.join(self.root_dir, self.scene_info['image_paths'][idx1])
        
        # TODO: Support augmentation & handle seeds for each worker correctly.
        # print("name ",img_name0)
