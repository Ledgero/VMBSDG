...
def test_mega1500(model, name):
    ...
    mega1500_benchmark = MegaDepthPoseEstimationBenchmark(DATA_PATH)
...
if __name__ == "__main__":
    ...
    device = "cuda"
    model = roma_outdoor(device = device, coarse_res = 672, upsample_res = 1344, use_custom_corr=True,weights=r"/home/ozq/MINIMA/train_results/minima_roma_360-minima/workspace_minima_roma_outdoor_360_2/checkpoints/train_roma_outdoor_20251209224451.pth")
    experiment_name = "roma_360minima_latest"
